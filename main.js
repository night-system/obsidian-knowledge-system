...
var SettingsRenderer = class {
  ...
  renderModifyYamlRules(containerEl) {
    ...
    const legend = new import_obsidian3.Setting(containerEl).setName("").setDesc(
      "\u5F00\u5173\u8BF4\u660E\uFF1A\n\xB7 \u66B4\u9732\u7ED9 AI\uFF1A\u5F00 = AI \u53EF\u89C1\u6B64\u5C5E\u6027\uFF0C\u53EF\u586B\u5199\u503C\uFF08\u4E0B\u65B9\u53EF\u9009\u503C\u7528\u4E8E\u7EA6\u675F\u53EA\u80FD\u9009\u8FD9\u4E9B\u503C\uFF0C\u7559\u7A7A=\u4EFB\u610F\uFF09\uFF1B\u5173 = AI \u5B8C\u5168\u770B\u4E0D\u5230\u6B64\u5C5E\u6027\u3001\u4E5F\u7981\u6B62 AI \u5199\u5165\u3002\n\xB7 \u8986\u5199\u9ED8\u8BA4\u503C\uFF1A\u5F00 = \u6BCF\u6B21\u4FEE\u6539\u6587\u4EF6\u65F6\u628A\u6B64\u5C5E\u6027\u5F3A\u5236\u8986\u5199\u4E3A\u9ED8\u8BA4\u503C\uFF08\u5982 created + {{YYYY-MM-DD HH:mm}} \u8BB0\u5F55\u672C\u6B21\u4FEE\u6539\u65F6\u95F4\uFF1B\u9ED8\u8BA4\u503C\u652F\u6301 {{moment}} \u6A21\u677F\uFF09\uFF1B\u5173 = \u4E0D\u4FEE\u6539\u6B64\u5C5E\u6027\u7684\u539F\u503C\uFF08\u539F\u6837\u4FDD\u7559\uFF0C\u5982 approve\uFF09\u3002\n\xB7 \u9ED8\u8BA4\u503C\uFF1A\u66B4\u9732\u65F6 = AI \u672A\u586B\u6B64\u952E\u624D\u81EA\u52A8\u8865\u5165\uFF1B\u4E0D\u66B4\u9732\u4E14\u8986\u5199\u5F00 = \u6BCF\u6B21\u5F3A\u5236\u8986\u5199\uFF1B\u7559\u7A7A = \u4E0D\u63D2\u5165/\u4E0D\u8986\u5199\u3002"
    );
  ...
  renderYamlRules(containerEl) {
    ...
    const legend = new import_obsidian3.Setting(containerEl).setName("").setDesc(
      "\u5F00\u5173\u8BF4\u660E\uFF1A\n\xB7 \u66B4\u9732\u7ED9 AI\uFF1A\u5F00 = AI \u53EF\u89C1\u6B64\u5C5E\u6027\uFF0C\u53EF\u586B\u5199\u503C\uFF08\u4E0B\u65B9\u53EF\u9009\u503C\u7528\u4E8E\u7EA6\u675F\u53EA\u80FD\u9009\u8FD9\u4E9B\u503C\uFF0C\u7559\u7A7A=\u4EFB\u610F\uFF09\uFF1B\u5173 = AI \u5B8C\u5168\u770B\u4E0D\u5230\u6B64\u5C5E\u6027\u3001\u4E5F\u7981\u6B62 AI \u5199\u5165\u3002\n\xB7 \u9ED8\u8BA4\u503C\uFF1A\u66B4\u9732\u65F6 = AI \u672A\u586B\u6B64\u952E\u624D\u81EA\u52A8\u8865\u5165\uFF1B\u4E0D\u66B4\u9732\u65F6 = \u521B\u5EFA\u6587\u4EF6\u81EA\u52A8\u8FFD\u52A0\u9ED8\u8BA4\u503C\uFF08\u5982 approve \u2192 \u672A\u5BA1\u6838\uFF09\uFF1B\u7559\u7A7A = \u4E0D\u63D2\u5165\u3002\n\xB7 \u9ED8\u8BA4\u503C\u652F\u6301 {{YYYY.MM.DD}} \u7B49 moment \u6A21\u677F\u3002"
    );
